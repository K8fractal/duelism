...
ReactDOM.render(
  <>
    ...
    <p>
      ...
      , etc.). For quick play, simply click "Get a random hand." For the full experience, draw 3 cards of the first two
      types, then discard any that you don't like or don't think fit. Repeat with next type, or two types, until you
      have a full hand.
    </p>
    <p>
